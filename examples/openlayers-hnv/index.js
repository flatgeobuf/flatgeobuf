...
const source = new ol.source.Vector({
    ...
    loader: async function (extent) {
        ...
        for await (const feature of flatgeobuf.deserialize('http://flatgeobuf.septima.dk/HNV2021_20210226.fgb', rect)) {
...
const resolutions = [1638.4, 819.2, 409.6, 204.8, 102.4, 51.2, 25.6, 12.8, 6.4, 3.2, 1.6, 0.8, 0.4, 0.2, 0.1, 0.05];

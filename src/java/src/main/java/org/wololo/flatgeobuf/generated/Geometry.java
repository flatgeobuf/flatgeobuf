...
public final class Geometry extends Table {
  ...
  public FlatGeobuf.Geometry parts(int j) { return parts(new FlatGeobuf.Geometry(), j); }
  public FlatGeobuf.Geometry parts(FlatGeobuf.Geometry obj, int j) { int o = __offset(18); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int partsLength() { int o = __offset(18); return o != 0 ? __vector_len(o) : 0; }
  public FlatGeobuf.Geometry.Vector partsVector() { return partsVector(new FlatGeobuf.Geometry.Vector()); }
  public FlatGeobuf.Geometry.Vector partsVector(FlatGeobuf.Geometry.Vector obj) { int o = __offset(18); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }

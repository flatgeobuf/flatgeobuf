...
public final class Feature extends Table {
  ...
  public FlatGeobuf.Geometry geometry() { return geometry(new FlatGeobuf.Geometry()); }
  public FlatGeobuf.Geometry geometry(FlatGeobuf.Geometry obj) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  ...
  public FlatGeobuf.Column columns(int j) { return columns(new FlatGeobuf.Column(), j); }
  public FlatGeobuf.Column columns(FlatGeobuf.Column obj, int j) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int columnsLength() { int o = __offset(8); return o != 0 ? __vector_len(o) : 0; }
  public FlatGeobuf.Column.Vector columnsVector() { return columnsVector(new FlatGeobuf.Column.Vector()); }
  public FlatGeobuf.Column.Vector columnsVector(FlatGeobuf.Column.Vector obj) { int o = __offset(8); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }

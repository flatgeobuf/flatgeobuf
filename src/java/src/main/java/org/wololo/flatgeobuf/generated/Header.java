...
public final class Header extends Table {
  ...
  public int srsCode() { int o = __offset(24); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  public String srsOrg() { int o = __offset(26); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer srsOrgAsByteBuffer() { return __vector_as_bytebuffer(26, 1); }
  public ByteBuffer srsOrgInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 26, 1); }
  ...
  public static void addSrsCode(FlatBufferBuilder builder, int srsCode) { builder.addInt(10, srsCode, 0); }
  public static void addSrsOrg(FlatBufferBuilder builder, int srsOrgOffset) { builder.addOffset(11, srsOrgOffset, 0); }

...
public final class Header extends Table {
  ...
  public FlatGeobuf.Column columns(FlatGeobuf.Column obj, int j) { int o = __offset(18); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public FlatGeobuf.Column.Vector columnsVector(FlatGeobuf.Column.Vector obj) { int o = __offset(18); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public FlatGeobuf.Crs crs() { return crs(new FlatGeobuf.Crs()); }
  public FlatGeobuf.Crs crs(FlatGeobuf.Crs obj) { int o = __offset(24); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }

...
public final class Header extends Table {
  ...
  public int indexNodeSize() { int o = __offset(18); return o != 0 ? bb.getShort(o + bb_pos) & 0xFFFF : 16; }
  public int srsCode() { int o = __offset(20); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  public String srsOrg() { int o = __offset(22); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer srsOrgAsByteBuffer() { return __vector_as_bytebuffer(22, 1); }
  public ByteBuffer srsOrgInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 22, 1); }
  ...
  public static void addIndexNodeSize(FlatBufferBuilder builder, int indexNodeSize) { builder.addShort(7, (short)indexNodeSize, (short)16); }
  public static void addSrsCode(FlatBufferBuilder builder, int srsCode) { builder.addInt(8, srsCode, 0); }
  public static void addSrsOrg(FlatBufferBuilder builder, int srsOrgOffset) { builder.addOffset(9, srsOrgOffset, 0); }

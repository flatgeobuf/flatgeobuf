...
public final class Feature extends Table {
  ...
  public long ringCounts(int j) { int o = __offset(6); return o != 0 ? (long)bb.getInt(__vector(o) + j * 4) & 0xFFFFFFFFL : 0; }
  public int ringCountsLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer ringCountsAsByteBuffer() { return __vector_as_bytebuffer(6, 4); }
  public ByteBuffer ringCountsInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 6, 4); }
  public long ringLengths(int j) { int o = __offset(8); return o != 0 ? (long)bb.getInt(__vector(o) + j * 4) & 0xFFFFFFFFL : 0; }
  public int ringLengthsLength() { int o = __offset(8); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer ringLengthsAsByteBuffer() { return __vector_as_bytebuffer(8, 4); }
  public ByteBuffer ringLengthsInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 8, 4); }
  public long lengths(int j) { int o = __offset(10); return o != 0 ? (long)bb.getInt(__vector(o) + j * 4) & 0xFFFFFFFFL : 0; }
  public int lengthsLength() { int o = __offset(10); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer lengthsAsByteBuffer() { return __vector_as_bytebuffer(10, 4); }
  public ByteBuffer lengthsInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 10, 4); }
  public double coords(int j) { int o = __offset(12); return o != 0 ? bb.getDouble(__vector(o) + j * 8) : 0; }
  public int coordsLength() { int o = __offset(12); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer coordsAsByteBuffer() { return __vector_as_bytebuffer(12, 8); }
  public ByteBuffer coordsInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 12, 8); }
  public int properties(int j) { int o = __offset(14); return o != 0 ? bb.get(__vector(o) + j * 1) & 0xFF : 0; }
  public int propertiesLength() { int o = __offset(14); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer propertiesAsByteBuffer() { return __vector_as_bytebuffer(14, 1); }
  public ByteBuffer propertiesInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 14, 1); }
  ...
  public static void addRingCounts(FlatBufferBuilder builder, int ringCountsOffset) { builder.addOffset(1, ringCountsOffset, 0); }
  ...
  public static void addRingLengths(FlatBufferBuilder builder, int ringLengthsOffset) { builder.addOffset(2, ringLengthsOffset, 0); }
  ...
  public static void addLengths(FlatBufferBuilder builder, int lengthsOffset) { builder.addOffset(3, lengthsOffset, 0); }

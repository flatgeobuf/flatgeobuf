...
import { buildGeometry, toSimpleGeometry } from './geometry'

import OLFeature from 'ol/Feature'

import { TextDecoder, TextEncoder } from 'util'

export function buildFeature(feature: OLFeature, header: HeaderMeta) {
...
export function fromFeature(feature: Feature, header: HeaderMeta) {
    const columns = header.columns
    const geometry = toSimpleGeometry(feature, header.geometryType)

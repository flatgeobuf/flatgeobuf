...
static addType(builder:flatbuffers.Builder, type:FlatGeobuf.GeometryType) {
  builder.addFieldInt8(1, type, FlatGeobuf.GeometryType.Point);
};
...
static addDimensions(builder:flatbuffers.Builder, dimensions:number) {
  builder.addFieldInt8(2, dimensions, 2);
};
...
static addEndss(builder:flatbuffers.Builder, endssOffset:flatbuffers.Offset) {
  builder.addFieldOffset(4, endssOffset, 0);
};
...
static addEnds(builder:flatbuffers.Builder, endsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(5, endsOffset, 0);
};
...
indexNodeSize():number {
  var offset = this.bb!.__offset(this.bb_pos, 12);
  return offset ? this.bb!.readUint32(this.bb_pos + offset) : 640;
};
...
featuresCount():flatbuffers.Long {
  ...
  return offset ? this.bb!.readUint64(this.bb_pos + offset) : this.bb!.createLong(1, 0);
};
...
static addIndexNodeSize(builder:flatbuffers.Builder, indexNodeSize:number) {
  builder.addFieldInt32(4, indexNodeSize, 640);
};
...
static addIndexNodesCount(builder:flatbuffers.Builder, indexNodesCount:number) {
  builder.addFieldInt32(5, indexNodesCount, 1);
};
...
static addFeaturesCount(builder:flatbuffers.Builder, featuresCount:flatbuffers.Long) {
  builder.addFieldInt64(7, featuresCount, builder.createLong(1, 0));
};
